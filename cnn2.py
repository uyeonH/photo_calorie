...
# 사진 데이터 읽어 들이기
#np_Array=np.load('C:/Users/yooye/OneDrive/바탕 화면/photos.npz')
#print(np_Array.files)
photos = np.load('C:/Users/yooye/OneDrive/바탕 화면/photos.npz')
x = photos['X']
y = photos['y']
...
model.save_weights('C:/Users/yooye/OneDrive/바탕 화면/photos-model.hdf5')
